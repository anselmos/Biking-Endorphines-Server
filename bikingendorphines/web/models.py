...
class Badge(models.Model):
    "Badge Model"
    name = models.CharField(max_length=50, help_text="describes in short name of the badge")
    description = models.CharField(max_length=256, default="", help_text="More thorough information about badge acquiring (i.e. criteria)")
