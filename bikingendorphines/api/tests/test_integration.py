...
from api.views import FileUploadView, PointList, PointView, UserBadgeList, UserDetail, UserList
from web.models import Badge, Point, Route, User, UserBadge
...
class TestUserList(APIGeneralTestCase):
    ...
    def assert_user_object(self, input_json, expected):
        ...
        self.assertEqual(input_json['name'], expected.name)
        self.assertEqual(input_json['surname'], expected.surname)
        self.assertEqual(input_json['weight'], expected.weight)
        self.assertEqual(input_json['height'], expected.height)
        self.assertEqual(input_json['bmi'], expected.bmi())
        self.assertEqual(input_json['bmi_health_name'], expected.bmi_health_name())
...
class TestUserBadgeList(APIGeneralTestCase):
    ...
    def assert_user_badge(
        ...
        self.assertEqual(user_badge_object['id_user'], user_id)
        self.assertEqual(user_badge_object['id_badge'], badge_id)
        self.assertEqual(user_badge_object['id_route'], route_id)
        self.assertEqual(user_badge_object['active'], active)
        self.assertEqual(
